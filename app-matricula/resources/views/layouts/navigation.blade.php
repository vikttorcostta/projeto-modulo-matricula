<nav x-data="{ open: false }" class="bg-gradient-to-r from-green-800 to-green-400 border-b border-gray-100 p-5 shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('professores.index')" :active="request()->routeIs('professores.index')">
                        {{ __('Professores') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        font-medium rounded-md text-green-700 bg-white hover:text-green-900 focus:outline-none transition ease-in-out duration-150">
                            <div class="flex flex-row items-center">
                                <span class="iconify mr-2 text-2xl" data-icon="solar:user-line-duotone"></span>
                                {{ Auth::user()->name }}
                            </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                ...
                text-white hover:text-gray-500 hover:bg-gray-100 focus:outline-none
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('professores.index')" :active="request()->routeIs('professores.index')">
                {{ __('Professores') }}
            </x-responsive-nav-link>
